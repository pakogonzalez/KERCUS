<script>
	jQuery("#gridMensajes").jqGrid({ 
		url:'mensajes/enviadostable', 
		datatype: "xml",
		colNames:['Id','Destino','Asunto','Texto','Fecha'],
		colModel:[ 
			{name:'id',index:'Mensaje.id',width:10,hidden:true},
			{name:'destino',index:'Mensaje.destino',width:50,editable:true,edittype:"select",editoptions:{value:"<?php echo $users;?>"}},
